...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="{{ url('/sneat') }}/assets" data-template="vertical-menu-template-free" >
  <head>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <div class="buy-now">
        {{-- <a href="{{ route('register') }}" target="_blank" class="btn btn-danger btn-buy-now" >Register</a > --}}
      </div>
