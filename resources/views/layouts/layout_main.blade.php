      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ url('main/home') }}" class="app-brand-link">
                <img style="width: 50%;" src="{{ url('/img/logo.png') }}" alt="">
              <span class="demo menu-text fw-bolder ms-2">LABKESDA</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="{{ url('main/home') }}" class="menu-link">
            ...
            <!-- Cards -->
{{-- @if (Auth::user()->user_jab_id == '3' || Auth::user()->user_jab_id == '1') --}}
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="extended-ui-perfect-scrollbar.html" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Pemeriksaan</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Paket Pemeriksaan</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-copy"></i>
                <div data-i18n="Extended UI">Loket</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="extended-ui-perfect-scrollbar.html" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Pasien</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-perfect-scrollbar.html" class="menu-link">
                    <div data-i18n="Perfect Scrollbar">Perusahaan</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">Kasir</div>
                  </a>
                </li>
              </ul>
            </li>
...
{{-- <li class="menu-item">
    <a href="{{ url('main/user') }}" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      {{-- <img src="{{ url('/img') }}/{{ auth()->user()->picture }}" alt class="w-px-5 h-auto rounded-circle" /> --}}
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          <div class="flex-shrink-0 me-3">
                            {{-- <div class="avatar avatar-online">
                              <img src="{{ url('/img') }}/{{ auth()->user()->picture }}" alt class="w-px-40 h-auto rounded-circle" />
                            </div> --}}
                          </div>
